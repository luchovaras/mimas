<?php
$time = 10; // una hora en mili-segundos 
...
setcookie(session_name(), '', time() - 24 * 10, $session_cookie_params['path'], $session_cookie_params['domain'], $session_cookie_params['secure'], $session_cookie_params['httponly']); 
