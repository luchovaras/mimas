...
$listar1 = $movimiento->seleccionarmov1ac($_SESSION['id']);
$listar2 = $movimiento->seleccionarmov2ac($_SESSION['id']);
$listar34 = $movimiento->seleccionarmov34ac($_SESSION['id']);
$total1 = $movimiento->sumar1ac($_SESSION['id']);
$total2 = $movimiento->sumar2ac($_SESSION['id']);
$total34= $movimiento->sumar34ac($_SESSION['id']);
...
<div class="container">
<div class="row">
<div class="titulo col-md-12">Resúmen de Cuenta</div>
</div>

<div style="margin-bottom:30px;" class="row">
				<?php
					$saldo = new usuario();
					$resultado = $saldo->saldo_disponible($_SESSION['id']);
					foreach ( $resultado as $row_s) {
					?>	
						<div class="col-md-6 red limite">
							Limite de compra:<strong> $ <?php echo number_format($row_s['limitecompra'],2,",",".");?></strong>
						</div>
							<div class="col-md-6 right red limite">
								Saldo disponible:<strong> $ <?php echo number_format($row_s['disponible'],2,",",".");?></strong>
							</div>
