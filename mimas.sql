...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-11-2019 a las 23:35:27
...
INSERT INTO `estados` (`id_estado`, `nombre`, `detalle`) VALUES
(1, 'No contactado', 'El usuario se registro y todavía no se ha contactado'),
(2, 'No contesta llamado', ''),
(3, 'No contesta correo', ''),
(4, 'Llamar mas tarde', ''),
(5, 'Contactar por WhatsApp', ''),
(6, 'No quiere mas informacion ', '');
...
CREATE TABLE `facultad` (
  ...
  `nombre_facultad` varchar(500) NOT NULL,
  `cod_facultad` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `facultad` (`id_facultad`, `nombre_facultad`, `cod_facultad`) VALUES
(1, 'Medicina Veterinaria', '2545'),
(2, 'Ciencias de la Salud', '8896');
...
CREATE TABLE `leads` (
  ...
  `ip_interesado` varchar(200) NOT NULL,
  `sede` int(20) NOT NULL,
  `fecha` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `id_estado` int(20) NOT NULL DEFAULT '1',
...
INSERT INTO `leads` (`id_lead`, `nombres`, `apellidos`, `identificacion`, `celular`, `correo`, `observacion`, `ip_interesado`, `sede`, `fecha`, `id_estado`, `id_departamento`, `id_municipio`) VALUES
(1, 'luciano', 'varas', '42407820934', '472389479238', 'luciano@gmail.com', 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.', '198.165.2.1', 3, '2019-11-20 15:54:00', 2, 11, 547),
(15, 'catalina', 'taborda velazquez', '4565416231165', '564615165165', 'catalina@gmail.com', 'Loque lorem', '192.165.232.3', 2, '2019-11-22 20:26:10', 3, 13, 2),
(16, 'Walter', 'Varas', '5646545', '546546516565', 'lunatico@mail.com', '', '125.125.1.1', 21, '2019-11-22 22:09:40', 1, 13, 2);
...
CREATE TABLE `programa` (
  ...
  `snies_programa` varchar(500) NOT NULL,
  `cod_programa` varchar(200) NOT NULL,
  `facultad_programa` int(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `programa` (`id_programa`, `nombre_programa`, `snies_programa`, `cod_programa`, `facultad_programa`) VALUES
(1, 'Estudio de las pequeñas especies', '42115135135154', '55665', 1),
(2, 'Medicina', '546541313513', '22245', 2);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `programaxlead`
--

CREATE TABLE `programaxlead` (
  `id_facxprog` int(20) NOT NULL,
  `id_facultad` int(20) NOT NULL,
  `id_programa` int(20) NOT NULL,
  `id_lead` int(20) NOT NULL,
  `fecha_registro` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `programaxlead`
--

INSERT INTO `programaxlead` (`id_facxprog`, `id_facultad`, `id_programa`, `id_lead`, `fecha_registro`) VALUES
(1, 1, 1, 1, '2019-11-22 19:38:57'),
(2, 2, 2, 1, '2019-11-22 20:03:24'),
(3, 1, 2, 15, '2019-11-22 20:14:15'),
(4, 2, 2, 15, '2019-11-22 20:14:15'),
(5, 2, 2, 15, '2019-11-22 21:16:08');
...
INSERT INTO `usuarios` (`id_usuario`, `nombres_usuario`, `apellidos_usuario`, `usuario_usuario`, `clave_usuario`, `correo_usuario`, `tipo_usuario`) VALUES
(1, 'luciano', 'varas', 'wvaras', 'luciano22', 'luciano@gmail.com', 1);
...
--
-- Indices de la tabla `programaxlead`
--
ALTER TABLE `programaxlead`
  ADD PRIMARY KEY (`id_facxprog`);
...
--
-- AUTO_INCREMENT de la tabla `programaxlead`
--
ALTER TABLE `programaxlead`
  MODIFY `id_facxprog` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
